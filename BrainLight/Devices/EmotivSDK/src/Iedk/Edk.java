...
public interface Edk extends Library {
	...
	public enum EE_DataChannels_t {
		...
		ED_INTERPOLATED(1),       //!< Indicate if data is interpolated
		ED_RAW_CQ(2),             //!< Raw contact quality value
		ED_AF3(3),                //!< Channel AF3
		ED_F7(4),                 //!< Channel F7
		ED_F3(5),                 //!< Channel F3
		ED_FC5(6),                //!< Channel FC5
		ED_T7(7),                 //!< Channel T7
		ED_P7(8),                 //!< Channel P7
		ED_Pz(9),                 //!< Channel Pz
		ED_O1(9),        		   //!< Channel O1 = Pz
		ED_O2(10),                //!< Channel O2
		ED_P8(11),                //!< Channel P8
		ED_T8(12),                //!< Channel T8
		ED_FC6(13),               //!< Channel FC6
		ED_F4(14),                //!< Channel F4
		ED_F8(15),                //!< Channel F8
		ED_AF4(16),               //!< Channel AF4
		ED_GYROX(17),             //!< Gyroscope X-axis
		ED_GYROY(18),             //!< Gyroscope Y-axis
		ED_TIMESTAMP(19),         //!< System timestamp
		ED_ES_TIMESTAMP(20),      //!< EmoState timestamp
		ED_FUNC_ID(21),           //!< Reserved function id
		ED_FUNC_VALUE(22),        //!< Reserved function value
		ED_MARKER(23),            //!< Marker value from hardware
		ED_SYNC_SIGNAL(24);       //!< Synchronisation signal

		private int cType;

		EE_DataChannels_t(int val) {
			cType = val;
		}
